...
(function () {
  ...
  box.innerHTML =
    ...
    '</div>' +
    '<div class="info-box"><h3>📊 분야별 정답률</h3>' + categories.map(function (f) {
    ...
    '<div class="info-box"><h3>📚 분야별 학습량</h3>' + categories.map(function (f) {
